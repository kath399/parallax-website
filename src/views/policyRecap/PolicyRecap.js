...
const PolicyRecap = () => {
  ...
  return (
    <section id="policyRecap" className="policyRecap">
      <Fade down duration={2000}>
        <img alt="Policy Recap" className="" />
      </Fade>
      <div className="policyTitle">Policy Recap</div>
      <div className="policyText">
        You shouldn’t need legal training to understand what you are and are not
        covered for. Which is why we created the Policy Translator. A useful
        tool that scans your PDS document and turns it into a fast, easy to read
        experience that makes everything important in your policy obvious and
        unmissable.
